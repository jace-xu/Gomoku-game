...
## 如果你喜欢这个项目，或者这个项目对你有帮助，请给我们一个star⭐
## 这对我们很重要，真的非常感谢！！

## 项目简介

本项目为小组成员基于 Python 语言开发的**五子棋智能对弈系统**，旨在实现人机对战、双人对战、自动复盘评语、历史记录与多样化界面体验等功能。。  
本项目仍在持续完善中，欢迎随时Issue！
...
- **AI自动评语**  
  - 集成 LLM（大语言模型）自动分析每盘对局（本程序使用的deepseek API）
  - 没有网络时自动回退为本地模板评语
...
- **皮肤与BGM资源**  
  ...
  - 如想要自定义，可自行在对应文件位置上传动画帧/背景/音效资源，菜单背景与落子目前暂只支持单一选择，BGM部分支持选择多个曲目，棋盘背景支持多图片文件选择。
...
6. 在"Settings"中可切换皮肤、音量、难度、BGM等个性化配置
...
- **音频上传限制**
  - `setting_ui.py`只支持读取`assets/BGM/`中的曲目。
...
- 如遇问题请附详细环境、操作步骤和错误信息，在github中issue或者联系邮箱2661567025@qq.com
